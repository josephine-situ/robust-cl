...
\begin{frame}{Next steps}
  ...
  \begin{enumerate}
    \item \textbf{Resolve the axis.} Grid past $\rho{=}1$ (CP censored); CP's
      ...
      feasibility $0$).
    \item \textbf{CV the synthetic embedded model.} Hard-coded \texttt{rf} 50/5;
      its CV has never been run and the sweep would ignore it.
    \item \textbf{Fix synthetic scoring.} Oracle is that same \texttt{rf} 50/5
      $+50$ rows: correlated errors, feasibility optimistic. Val rows unused
